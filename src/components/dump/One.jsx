      ...
      <div className="backgroundColor">
        <div className="contentWrapper">
          ...
          <div className="firstWrapper">
            ...
            >
              <img
                src={`${process.env.PUBLIC_URL}/assets/images/one/mouseImg.png`}
                alt=""
                draggable={false}
              />
              <Syllable
            ...
            >
              <img
                src={`${process.env.PUBLIC_URL}/assets/images/one/footImg.png`}
                alt=""
                draggable={false}
              />
              <Syllable
            ...
            >
              <img
                src={`${process.env.PUBLIC_URL}/assets/images/one/handImg.png`}
                alt=""
                draggable={false}
              />
              <Syllable
          ...
          <div className="firstWrapper">
            ...
            >
              <img
                src={`${process.env.PUBLIC_URL}/assets/images/one/momImg.png`}
                alt=""
                draggable={false}
              />
      ...
      <DragItemsWrapper>
        {consonantArr.map((consonant, index) => (
          ...
          <img
            ...
            src={`${process.env.PUBLIC_URL}/assets/images/one/c_${consonant}.png`}
            alt=""
            // draggable={false}
